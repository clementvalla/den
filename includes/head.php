...
<body <?php if ($page_name == 'save') { ?>id="save" class="static-diagram"<?php } ?>>
	...
	<header class="container blur">
        <h1 class="brand ml2 mt1 mobile-center"><a href="http://parseshare.com/den/">The Venn <br class="mobile-hide">Diagram <br class="mobile-hide">Generator</a></h1>
        ...
        <br>
        <a class="button button-box-black button-small mt2 ml2 mobile-hide" href="venn-library.php">
Library</a>
